...
class DataGenerator(KU.Sequence):
    ...
    def __init__(self, dataset, config, model_dir, shuffle=True, augmentation=None,
        ...
        self.indexes = np.arange(len(self.image_ids))  # Initialize indexes
        self.on_epoch_end()
    ...
    def __getitem__(self, idx):
        ...
        print("Input types:", [type(inp) for inp in inputs])
        print("Input shapes:", [inp.shape for inp in inputs])
        print("Output types:", [type(out) for out in outputs])
...
class MaskRCNN(object):
    ...
    def __init__(self, mode, config, model_dir):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        # super(MaskRCNN, self).__init__(mode, config, model_dir)
        # self.keras_model.dynamic = True
